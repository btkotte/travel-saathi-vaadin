...
import com.example.application.views.mytravels.MyTravelsView;
...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        Span appName = new Span("Travel Saathi");
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(MyTravelsView.class)) {
            nav.addItem(new SideNavItem("My Travels", MyTravelsView.class, LineAwesomeIcon.BUS_SOLID.create()));

        }
        if (accessChecker.hasAccess(ChatView.class)) {
            nav.addItem(new SideNavItem("Chat", ChatView.class, LineAwesomeIcon.ROCKETCHAT.create()));
